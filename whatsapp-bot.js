...
const OWNER_USER_ID = '628123456789@c.us'; // <-- GANTI INI!
...
setTimeout(async () => {
    try {
        ...
        console.log('⏳ Tunggu sebentar, pairing code akan muncul...');
    }
}, 15000);
